...
import com.daon.daon_ui.databinding.FragmentJoin7Binding

class JoinFragment7 : Fragment() {
    private var _binding: FragmentJoin7Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJoin7Binding.inflate(inflater, container, false)
        ...
        binding.nextBtn.setOnClickListener {
            navController.navigate(R.id.action_JoinFragment7_to_JoinFragment8)
        ...
        binding.skipBtn.setOnClickListener {
            navController.navigate(R.id.action_JoinFragment7_to_HomeFragment)
