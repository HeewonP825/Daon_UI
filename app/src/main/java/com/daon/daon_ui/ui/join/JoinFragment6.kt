...
import com.daon.daon_ui.databinding.FragmentJoin6Binding

class JoinFragment6 : Fragment() {
    private var _binding: FragmentJoin6Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJoin6Binding.inflate(inflater, container, false)
        ...
        binding.nextBtn.setOnClickListener {
            navController.navigate(R.id.action_JoinFragment6_to_JoinFragment7)
