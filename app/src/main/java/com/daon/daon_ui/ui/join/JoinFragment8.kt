...
class JoinFragment8 : Fragment() {
    private var _binding: FragmentJoin8Binding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentJoin8Binding.inflate(inflater, container, false)
        ...
        binding.skipBtn.setOnClickListener {
            navController.navigate(R.id.action_JoinFragment8_to_HomeFragment)
